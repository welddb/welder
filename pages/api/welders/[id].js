...
const welderApi = async (req, res) => {
    ...
    if(session){
        await dbConnect();
            switch (req.method) {
                case 'GET':
                    return await WelderController.getWelderDetailsController(req,res);
                case 'PUT':
                    return await WelderController.editWelderController(req,res);
                case 'DELETE':
                    return await WelderController.deleteWelderDetailsController(req,res);
                default:
